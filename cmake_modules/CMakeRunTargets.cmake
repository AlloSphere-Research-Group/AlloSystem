...
if(BUILD_DIR)
  ...
  file(GLOB ALLOSYSTEM_APP_SRC RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} ${ALLOSYSTEM_BUILD_APP_DIR}/*.cpp)
...
if(TARGET allosphere${DEBUG_SUFFIX})
	...
	add_dependencies("${APP_NAME}" allosphere${DEBUG_SUFFIX})
	target_link_libraries("${APP_NAME}" ${ALLOSPHERE_LIBRARY} ${ALLOSPHERE_LINK_LIBRARIES})
