...
if(TARGET alloaux${DEBUG_SUFFIX})
    get_target_property(ALLOAUX_LIBRARY alloaux${DEBUG_SUFFIX} LOCATION)
    get_target_property(ALLOAUX_DEP_INCLUDE_DIR alloaux${DEBUG_SUFFIX} ALLOAUX_DEP_INCLUDE_DIR)
    get_target_property(ALLOAUX_LINK_LIBRARIES alloaux${DEBUG_SUFFIX} ALLOAUX_LINK_LIBRARIES)
    add_dependencies("${APP_NAME}" alloaux${DEBUG_SUFFIX})
    target_link_libraries("${APP_NAME}" ${ALLOAUX_LIBRARY} ${ALLOAUX_LINK_LIBRARIES})
    include_directories(${ALLOAUX_DEP_INCLUDE_DIR})
else()
  if(NOT ALLOAUX_FOUND)
    set(ALLOAUX_LIBRARY "")
    set(ALLOAUX_DEP_INCLUDE_DIR "")
    message("Not building ALLOAUX and no usable ALLOAUX binary found. Not linking application to ALLOAUX")
  endif(NOT ALLOAUX_FOUND)
endif(TARGET alloaux${DEBUG_SUFFIX})
