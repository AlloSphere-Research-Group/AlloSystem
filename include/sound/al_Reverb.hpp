...
protected:
	...
	DelayLine<T,A> mPreDelay;
	OnePole<T> mOPIn;
	DelayLine<T,A> mAPIn1, mAPIn2, mAPIn3, mAPIn4;
	DelayLine<T,A> mAPDecay11, mAPDecay12, mDly11, mDly12;
	OnePole<T> mOP1;
	DelayLine<T,A> mAPDecay21, mAPDecay22, mDly21, mDly22;
	OnePole<T> mOP2;
};
