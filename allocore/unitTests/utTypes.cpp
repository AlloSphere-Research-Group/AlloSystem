...
//		Array field(3, Array::type<float>(), 16, 16, 16);
	...
	}
	{
		...
		assert(Colori(10,20,30).at<1>() == 20);
		assert(Colori(9).set<1>(1) == Colori(9,1,9));
		...
		assert(Colori(2,4,8,128).preMul() == Colori(1,2,4,128));
		assert(Colori(2,4,8,0).preMul() == Colori(0,0));
