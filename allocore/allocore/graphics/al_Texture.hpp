#ifndef INC_AL_TEXTURE_HPP
#define INC_AL_TEXTURE_HPP

/*	Allocore -- Multimedia / virtual environment application class library

	Description:
	Helper object for GPU texture
...
public:
	...
	enum Wrap {
		...
		#ifdef AL_GRAPHICS_SUPPORTS_WRAP_REPEAT_EXTRA
		MIRRORED_REPEAT			= GL_MIRRORED_REPEAT,
		#endif
		#ifdef AL_GRAPHICS_SUPPORTS_WRAP_CLAMP_EXTRA
		CLAMP					= GL_CLAMP,
