#ifndef INC_AL_QUAT_HPP
#define INC_AL_QUAT_HPP

/*	Allocore -- Multimedia / virtual environment application class library

	Description:
	A quaternion for representing spatial orientation including many different
	conversion routines to matrices, etc.
