#ifndef INC_AL_CONVERSION_HPP
#define INC_AL_CONVERSION_HPP

/*	Allocore -- Multimedia / virtual environment application class library

	File description:
	Grab bag of routines for converting between built-in types
...
/// The number of bits in the base-64 string (6 x string length) must be greater
/// than or equal to the number of bits in output data.
