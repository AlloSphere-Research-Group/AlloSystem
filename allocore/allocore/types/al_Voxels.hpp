...
/*	Allocore -- Multimedia / virtual environment application class library
	...
	Description:
	Structure for storing scientific volumetric data, containing physical metadata
	Base structure utilizes 3D AlloArray class, with support for MRC file format
