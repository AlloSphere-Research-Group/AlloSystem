...
void Graphics::draw(MeshVBO& meshVBO) {
	...
	if (meshVBO.hasIndices) glDrawElements(meshVBO.primitive(), meshVBO.num_indices, GL_UNSIGNED_INT, NULL);
	else glDrawArrays(meshVBO.primitive(), 0, meshVBO.num_vertices);
