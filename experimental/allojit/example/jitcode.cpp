...
class Agent : public Nav, public JitObject, public Drawable {
public:
...
class AgentSystem : public JitObject, public Drawable {
public:
...
extern "C" void onload(World * W, JIT * jit) {
	...
	W->drawables.attach(new AgentSystem(W, jit));
