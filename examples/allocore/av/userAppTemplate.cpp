/*
Allocore Example: User App Template

Description:
This is a very stripped down App subclass that can be used as a starting template
for projects. This is NOT an example of how to use the App class. See 'simpleApp.cpp'
in the same directory as this file for a pedagogical overview of the App class.
