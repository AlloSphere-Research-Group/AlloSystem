...
Description:
This shows basic usage of the Vec class which represents an n-dimensional vector or n-vector.
...
int main(){
	...
	*/
		...
		Vec2i h(arr2);			// It's okay for the C-array and vector to be different types
	/*
	...
	*/
	...
	/*
	For 1-, 2-, 3-, and 4-vectors, it is possible to use symbolic names. The symbols
	'x', 'y', 'z', and 'w' are used to access elements 0, 1, 2, and 3, respectively. E.g.:
	*/
	{	Vec2f b(1,2);
	...
	*/
	...
	{	Vec2f v(3,4);
		...
		A.dot(B);				// Returns -1 (=1*3 + 2*-2 + 3*0), the dot product of A and B
