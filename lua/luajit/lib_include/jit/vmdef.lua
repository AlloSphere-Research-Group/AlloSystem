...
irnames = "NOP   BASE  LOOP  PHI   RENAMEKPRI  KINT  KGC   KPTR  KNULL KNUM  KSLOT EQ    NE    ABC   FRAME LT    GE    LE    GT    ULT   UGE   ULE   UGT   BNOT  BSWAP BAND  BOR   BXOR  BSHL  BSHR  BSAR  BROL  BROR  ADD   SUB   MUL   DIV   FPMATHPOWI  NEG   ABS   ATAN2 LDEXP MIN   MAX   ADDOV SUBOV AREF  HREFK HREF  NEWREFUREFO UREFC FREF  STRREFALOAD HLOAD ULOAD FLOAD SLOAD XLOAD ASTOREHSTOREUSTOREFSTORESNEW  TNEW  TDUP  TLEN  TBAR  OBAR  TONUM TOINT TOBIT TOSTR STRTO "

irfpm = { [0]="floor", "ceil", "trunc", "sqrt", "exp", "exp2", "log", "log2", "log10", "sin", "cos", "tan", "other", }

irfield = { [0]="str.len", "func.env", "tab.meta", "tab.array", "tab.node", "tab.asize", "tab.hmask", "tab.nomm", "udata.meta", }
